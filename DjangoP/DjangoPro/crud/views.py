...
def update_classroom_view(request,id):
    ...
    if request.method == "POST":
        classroom_name= request.POST.get("classroom_name")
        section = request.POST.get("classroom_section")
        classroom.name = classroom_name#setting data to classroom obj
        classroom.section=section
        classroom.save()#store data to the table
        return redirect("crud_classroom")
...
def student_view(request):
    return render(request, template_name="crud/student_details.html", context={"students": Student.objects.all()})
...
def update_student_view(request,id):
    ...
    if request.method == "POST":
        ...
        student.save()
        return redirect("crud_student")
    return render(request,template_name="crud/update_student.html",context={"Students":student})
...
def student_profile_view(request):
    return render(request,template_name="crud/student_profile.html",context={"Profile":StudentProfile.objects.all()})
